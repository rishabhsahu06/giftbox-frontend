            ...
            products.map((product) => (
              ...
              >
                ...
                <div className="p-3 sm:p-4 flex flex-col flex-grow">
                  <h3 className="font-semibold text-gray-900 mb-2 sm:mb-3 text-sm sm:text-base line-clamp-2">
                    {product?.name}
                  </h3>
                  ...
                  <div className="flex-col md:flex-row flex gap-2 mt-auto">
                    <button
                      className="flex-1  cursor-pointer flex items-center justify-center gap-1 sm:gap-2 bg-white hover:bg-gray-50 text-gray-700 border border-gray-300 hover:border-red-500 px-3 sm:px-4 py-2 sm:py-2.5 rounded-md text-xs sm:text-sm font-medium transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                      onClick={() => handleAddCart(product)}
                      disabled={adding === product?._id || product?.stock === 0}
                    >
                      <span className="hidden xs:inline c">
                    ...
                    <button
                      className="flex-1 bg-red-500 hover:bg-red-600 text-white px-3 sm:px-4 py-2 sm:py-2.5 rounded-md text-[10px] sm:text-sm font-medium transition-all duration-200 shadow-md hover:shadow-lg cursor-pointer"
                      onClick={() => handleBuyNow(product)}
                    >
                      BUY NOW
                    </button>
